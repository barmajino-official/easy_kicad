...
from easy_kicad.easyeda.parameters_easyeda import Ee3dModel
from easy_kicad.kicad.parameters_kicad_footprint import Ki3dModel

VRML_HEADER = """#VRML V2.0 utf8
# 3D model generated by easy_kicad.py (https://github.com/uPesy/easy_kicad.py)
"""
